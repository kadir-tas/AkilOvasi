...
public class ShopItemImageBindingAdapter {
    ...
    public void loadImage(ImageView imageView, String shopItemId) {
        if (shopItemId != null && !shopItemId.equals(ApiConstants.EMPTY_STRING)) {
            picasso.load(BuildConfig.BASE_URL + ApiConstants.SHOP_ITEM_IMAGE_ENDPOINT_PREFIX + shopItemId).error(R.drawable.ic_photo_black_24dp)
                ...
                public void onError(Exception e) {
                    picasso.load(BuildConfig.BASE_URL + ApiConstants.SHOP_ITEM_IMAGE_ENDPOINT_PREFIX + shopItemId)
